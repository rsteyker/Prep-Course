...
function tablaDelSeis() {//Escribe una función que muestre la tabla de multiplicar del 6 (del 0 al 60).
...
module.exports = {
  obtenerMayor: obtenerMayor,
  mayoriaDeEdad: mayoriaDeEdad,
  conection: conection,
  saludo: saludo,
  colors: colors,
  esDiezOCinco: esDiezOCinco,
  ...
  tieneTresDigitos: tieneTresDigitos,
  doWhile: doWhile
};
//# sourceMappingURL=homework.dev.js.map
